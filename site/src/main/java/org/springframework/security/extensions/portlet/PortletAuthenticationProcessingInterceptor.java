 ...
 * @author John A. Lewis
 * @since 2.0
 * @version $Id: PortletAuthenticationProcessingInterceptor.java 3664 2009-05-12 05:37:11Z ltaylor $
 */
@SuppressWarnings("unchecked")
public class PortletAuthenticationProcessingInterceptor implements HandlerInterceptor, InitializingBean {

    //~ Static fields/initializers =====================================================================================

    private static final Log logger = LogFactory.getLog(PortletAuthenticationProcessingInterceptor.class);
    ...
    private AuthenticationDetailsSource<PortletRequest, GrantedAuthoritiesContainer> authenticationDetailsSource;
    ...
    protected Object getPrincipalFromRequest(PortletRequest request) {
        ...
        if (this.userNameAttributes != null) {
            ...
            if (userInfo != null) {
                ...
                while(i.hasNext()) {
                    Object principal = userInfo.get(i.next());
                    if (principal != null) {
                        return principal;
                    }
                }
